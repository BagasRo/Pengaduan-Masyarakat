...
Public Class FormLaporanAdmin
	...
	Sub munculDataGridView_statusSelesai()
		...
		Call koneksi()
		da = New MySqlDataAdapter("SELECT pengaduan.isi_laporan, pengaduan.foto, tanggapan.tanggapan, pengaduan.tgl_pengaduan, tanggapan.tgl_penanggapan,pengaduan.lokasi, pengaduan.status
	...
	Sub munculDataGridView_statusProses()
		...
		da = New MySqlDataAdapter("SELECT pengaduan.id_pengaduan, pengaduan.foto, pengaduan.isi_laporan, pengaduan.tgl_pengaduan, pengaduan.lokasi, pengaduan.status 
                               FROM pengaduan 
                               WHERE pengaduan.status = 'proses'", conn)
		...
		Try
			If ComboBox1.Text = "Proses" Then
				If DataGridView1.RowCount > 0 Then
					...
					Dim imgData As Byte() = DataGridView1.Rows(e.RowIndex).Cells(1).Value
					If Not IsDBNull(imgData) Then
